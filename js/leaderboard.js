...
const template = require('./../templates/leaderboard.js');
  ...
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      if (response.status !== 200 || responseJson.errorMessage) {
        return reject(new Error(`Error: ${responseJson.errorMessage}`));
      } else {
...
},{"./../deps/lodash.4.17.15.js":2,"./../templates/leaderboard.js":4,"dompurify":1}],4:[function(require,module,exports){
module.exports = `<table class="leaderboard-table">
